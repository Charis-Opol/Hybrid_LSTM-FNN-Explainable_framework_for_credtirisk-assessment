...
def main() -> None:
    ...
    LOGGER.info("Starting model training (epochs=50, batch_size=128)")
    ...
    explain_artifacts = explainer.explain(
        ...
        background_size=min(200,len(y_val)),
        explanation_size=min(100,len(y_val))
    )
